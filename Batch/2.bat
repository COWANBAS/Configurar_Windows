...
echo desabilitando Windows Update Medic Service
sc config "WaaSMedicSvc" staret=disabled

echo desabilitando Windows Update...
sc config "wuauserv" start=disabled

echo desabilitando Windows PushToInstall Service...
sc config "PushToInstall" start=disabled

echo desabilitando Windows Push Notifications System Service...
sc config "WpnService" start=disabled

echo desabilitando Windows License Manager Service...
sc config "LicenseManager" start=disabled

echo desabilitando Windows Event Log...
sc config "EventLog" start=disabled

echo desabilitando Windows Camera Frame Server...
sc config "FrameServer" start=disabled

echo desabilitando Windows Backup...
sc config "SDRSVC" start=disabled

echo desabilitando Wi-Fi Direct Services Connection Manager Service...
sc config "WFDSConMgrSvc" start=disabled

echo desabilitando Volumetric Audio Compositor Service...
sc config "VacSvc" start=disabled

echo desabilitando Themes...
sc config "Themes" start=disabled

echo desabilitando System Event Notification Service...
sc config "SENS" start=disabled

echo desabilitando Spot Verifier...
sc config "svsvc" start=disabled

echo desabilitando Smart Card Removal Policy
sc config "SCPolicySvc" start=disabled

echo desabilitando Smart Card Device Enumeration Service...
sc config "ScDeviceEnum" start=disabled

echo desabilitando serviço Smart Card...
sc config "SCardSvr" start=disabled

echo desabilitando serviço Remote Desktop Services UserMode Port Redirector...
sc config "UmRdpService" start=disabled

echo desabilitando serviço Recommended Troubleshooting Service...
sc config "TroubleshootingSvc" start=disabled

echo desabilitando serviço Quality Windows Audio Video Experience...
sc config "QWAVE" start=disabled

echo desabilitando serviço Problem Reports Control Panel Support...
sc config "wercplsupport" start=disabled

echo desabilitando serviço Plug and Play...
sc config "PlugPlay" start=disabled

echo desabilitando serviço Microsoft Cloud Identity Service...
sc config "cloudidsvc" start=disabled

echo desabilitando serviço McpManagementService...
sc config "McpManagementService" start=disabled

echo desabilitando serviço Language Experience Service...
sc config "LxpSvc" start=disabled

echo desabilitando serviço Hyper-V Volume Shadow Copy Requestor...
sc config "vmicvss" start=disabled

echo desabilitando serviço Hyper-V Time Synchronization Service...
sc config "vmictimesync" start=disabled

echo desabilitando serviço Hyper-V Remote Desktop Virtualization Service...
sc config "vmicrdv" start=disabled

echo desabilitando serviço Hyper-V PowerShell Direct Service...
sc config "vmicvmsession" start=Disabled

echo desabilitando serviço Hyper-V Heartbeat Service...
sc config "vmicheartbeat" start=Disabled

echo desabilitando serviço Hyper-V Guest Shutdown Service...
sc config "vmicshutdown" start=Disabled

echo desabilitando serviço Hyper-V Guest Service Interface...
sc config "vmicguestinterface" start=Disabled

echo desabilitando serviço Hyper-V Data Exchange Service...
sc config "vmickvpexchange" start=Disabled

echo desabilitando serviço HV Host Service...
sc config "HvHost" start=Disabled

echo desabilitando serviço File History Service...
sc config "fhsvc" start=Disabled

echo desabilitando serviço Distributed Transaction Coordinator...
sc config "MSDTC" start=Disabled

echo desabilitando serviço BranchCache...
sc config "PeerDistSvc" start=disabled

echo desabilitando serviço Volumetric Audio Compositor Service...
sc config "VacSvc" start=disabled

echo desabilitando serviço Performance Logs & Alerts...
sc config "pla" start=disabled

echo Desabilitando serviço NaturalAuthentication...
